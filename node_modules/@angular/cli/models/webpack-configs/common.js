...
function getCommonConfig(wco) {
    ...
    return {
        ...
        output: {
            ...
            filename: `app-assets/scripts/bundle/[name]${hashFormat.chunk}.bundle.js`,
            chunkFilename: `app-assets/scripts/chunk/[id]${hashFormat.chunk}.chunk.js`
        },
        module: {
            rules: [
                { enforce: 'pre', test: /\.js$/, loader: 'source-map-loader', exclude: [nodeModules] },
                { test: /\.html$/, loader: 'raw-loader' },
                { test: /\.(eot|svg|cur)$/, loader: `file-loader?name=app-assets/fonts/[name]${hashFormat.file}.[ext]` },
                {
                    test: /\.(jpg|png|webp|gif)$/,
                    loader: `url-loader?name=app-assets/images/[name]${hashFormat.file}.[ext]&limit=10000`
                },
                {
                    test: /\.(otf|ttf|woff|woff2|ani)$/,
                    loader: `url-loader?name=app-assets/fonts/[name]${hashFormat.file}.[ext]&limit=10000`
                }
            ].concat(extraRules)
        },
        plugins: [
